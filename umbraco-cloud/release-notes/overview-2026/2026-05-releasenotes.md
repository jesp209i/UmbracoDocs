...
You can now upload custom HTML error pages directly from the Umbraco Cloud Portal and assign them to any hostname across your environments. When an environment restarts — for example, during a deployment — visitors see your page instead of the default Umbraco Cloud error page.
